...
export default function HeroSection({ name, mainTitle, paragraph, card1, card2 }: heroData) {
  return (
    <section className="min-h-screen bg-[#fefefe] flex justify-center">
      <div className="w-full grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-500 px-5 md:my-10 text-lg ">
              {paragraph}
            </p>
          </div>
        ...
        <div className="relativ flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-2 w-full">
            <a href="#" className="relative group p-6 pt-24 z-1 bg-[#fcfcfc] transition overflow-hidden cursor-pointer">
              <h3 className="font-semibold  text-black group-hover:text-[#fcfcfc] text-lg">
                {card1.title}
              </h3>
              <p className="text-sm text-gray-800 group-hover:text-gray-400 mt-1">
                {card1.paragraph}
              </p>
              ...
              <div className="w-full h-full absolute bg-black -z-1 top-full group-hover:top-2/5  left-0 transition-all"></div>
            </a>
            <a href="#" className="relative group p-6 pt-24 z-1 bg-black transition overflow-hidden cursor-pointer">
              <h3 className="font-semibold text-[#fcfcfc] group-hover:text-black text-lg">
                {card2.title}
              </h3>
              <p className="text-sm text-gray-400 group-hover:text-gray-800 mt-1">
                {card2.paragraph}
              </p>
              <span className="absolute mix-blend-difference top-8 right-6">
                <svg
              ...
              <div className="w-full h-full absolute bg-white -z-1 top-full group-hover:top-2/5  left-0 transition-all"></div>
            </a>
          </div>
        </div>
      </div>
