...
export default function Header({ resumeLink = "https://googleDriveLink" }: { resumeLink?: string }) {
  return (
    <nav className="w-full md:h-22.5 bg-muted">
      <div className="max-w-7xl  mx-auto flex items-center justify-between px-4 md:px-8 py-4">
        ...
        <ul className=" h-8 flex items-center justify-center-center md:gap-8 gap-4 text-foreground text-lg">
          ...
          <li className="hover:text-primary cursor-pointer"><a href="/projects">Work</a></li>
          <li className="hover:text-primary cursor-pointer"><a href={resumeLink} target="_blank" rel="noopener noreferrer">Resume</a></li>
          ...
          <li className="hover:text-primary cursor-pointer hidden md:inline"><a href="/contact">Contact</a></li>
        </ul>
      </div>
    </nav>
  );
